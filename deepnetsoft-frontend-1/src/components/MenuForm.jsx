...
const MenuForm = () => {
  ...
  const fetchCurrentMenu = async (category) => {
    try {
      const response = await fetch(`https://deepnetsoftmenubackend.onrender.com/api/menus/${category}`);
      if (response.ok) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("https://deepnetsoftmenubackend.onrender.com/api/menus/add-item", {
        method: "POST",
        headers: {
